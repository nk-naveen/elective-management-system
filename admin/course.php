...
$ret=mysqli_query($bd, "insert into course(courseCode,courseName,noofSeats,semester) values('$coursecode','$coursename','$seatlimit','$sem')");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="sem" name="semester" placeholder="semester" required />
  </div>  
