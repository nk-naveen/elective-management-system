...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <br><br>
      <h2 align="center">Elective 2 & 4 Enrolled list</h2>
      <br>
      <table class="table table-bordered print">
        ...
        <tbody>
          <?php
          $sn=1;
          $user_qry="select * from students s,courseenrolls ce,course c where c.id=ce.course2 and ce.studentRegno=s.StudentRegno ";
