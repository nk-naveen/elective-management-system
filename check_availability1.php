...
if(!empty($_POST["cid"])) {
	...
	//echo 'course id: '.$cid=4; echo'</br>';
		$res1 =mysqli_query($bd, "SELECT count(studentRegno) as nst FROM courseenrolls WHERE course2='$cid' and studentRegno='$un'");
...
//if(!empty($_POST["cid"])) {
	//$cid= $_POST["cid"];
		...
		$res2 =mysqli_query($bd, "SELECT count(id) as tc FROM courseenrolls WHERE course2='$cid'  and studentRegno='$un'");
