...
$un=$_SESSION['login'];
$sl=0;
$sql=mysqli_query($bd, "select * from students s,courseenrolls ce,course c where c.id=ce.course1 and ce.studentRegno=s.StudentRegno and s.studentRegno='$un'");
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><div align="center">
                                            <a href="print.php?id=<?php echo $pcid; ?>" target="_blank">
...
$un=$_SESSION['login'];
$sl=0;
$sql=mysqli_query($bd, "select * from students s,courseenrolls ce,course c where c.id=ce.course2 and ce.studentRegno=s.StudentRegno and s.studentRegno='$un'");
while($row=mysqli_fetch_array($sql))
{
    $sl++;
?>
